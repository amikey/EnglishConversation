...
public class HalamanTambahArtikel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmitarticle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content),"Hallo Snackbar, selamat datang di aplikasi percakapak bahasa inggris. Selamt belajar.", Snackbar.LENGTH_LONG);
