...
//                        Toast.makeText(HalamanDaftar.this, "Registration complete, please check email!", Toast.LENGTH_SHORT).show();
                        Toasty.success(HalamanDaftar.this, "Registration complete, please check email!", Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(HalamanDaftar.this, "Registration Failed!", Toast.LENGTH_SHORT).show();
                            Toasty.error(HalamanDaftar.this, "Registration Failed!", Toast.LENGTH_SHORT).show();
//                            emailVerification();
                        }
                        if (!task.isSuccessful()) {
